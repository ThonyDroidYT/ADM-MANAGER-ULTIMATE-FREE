...
wget https://raw.githubusercontent.com/ThonyDroidYT/ADM-MANAGER-ULTIMATE-FREE/master/adm-server.tgz > /dev/null 2>&1
wget https://raw.githubusercontent.com/ThonyDroidYT/ADM-MANAGER-ULTIMATE-FREE/master/bin.tgz > /dev/null 2>&1
...
wget -O trans https://raw.githubusercontent.com/ThonyDroidYT/ADM-MANAGER-ULTIMATE-FREE/master/Install/trans -o /dev/null 2>&1
mv -f ./trans /bin/ && chmod 777 /bin/*
echo -e "\033[1;35m ° VERIFICADO\033[0m"

echo -e "\033[1;36mwget https://raw.githubusercontent.com/ThonyDroidYT/ADM-MANAGER-ULTIMATE-FREE/master/Install/apt-source.sh && chmod 777 ./* && ./apt-*" > /dev/null 2>&1
